! function(e) {
  function r(r) {
    for (var n, i, u = r[0], c = r[1], f = r[2], s = 0, p = []; s < u.length; s++) i = u[s], o[i] && p.push(o[i][0]), o[i] = 0;
  ...
  nSQL: function(e, r, t) {
    ...
    var i = {
      ...
      u = function(e, r) {
        "IMG" === e.tagName || "IFRAME" === e.tagName ? e.src = r : e.style.backgroundImage = "url(" + r + ")", e.classList.remove("img-lazy", "iframe-lazy")
      },
      c = function(e, r) {
        e.forEach(function(e) {
          e.isIntersecting && (u(e.target, e.target.getAttribute("data-src")), r.unobserve(e.target))
        })
      },
      f = r.LazyImageLoader = function() {
        ...
        return n(e, null, [{
          key: "init",
          value: function() {
            var e = [].concat(a((0, o.querySelector)(".img-lazy")), a((0, o.querySelector)(".iframe-lazy")));
